...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: puKm7ksVLVR/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: fcoms_diEDe/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 3EnnKuvE8Es/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__b3Q61)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__grXUl)}
                role={"img"}
              />
            ),
